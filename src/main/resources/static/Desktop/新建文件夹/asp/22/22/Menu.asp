...
//        菜单开始
//==========================
//菜单原提供：www.echsys.com
//制作：龙之吻,
//QQ：419351935  542459883
//时间：2005.05.01
//E创政府网站管理系统
//版权所有：E创网络
//原 mt_dropdownC.js
...
If Rstype.Bof And Rstype.Eof Then 
	strtype = strtype & "栏目正在建设中,请登录后台设置栏目！ "
else
	Rstype.movefirst
	Strtype=Strtype &"<ul>"
		Do While Not Rstype.Eof
			'菜单条(大类)
			If Rstype("url")<>"" Then
			Strtype = strtype & "<li><a href='"& rstype("url") &"' id=menu"& Type_i &" title='"& rstype("typecontent") &"'>"& rstype("E_typename") &"</a></li>"
			Else
			strtype = strtype & "<li><a href='E_Type.asp?E_typeid="& rstype("E_typeid") &"' id=menu"& Type_i &" title='"& rstype("typecontent") &"'>"& rstype("E_typename") &"</a></li>"
			End if
			Rstype.MoveNext
			Type_i=Type_i+1
		Loop
